...
{
    [Guid("90E9D617-A4B1-4DDE-B842-60BECC114255")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
    [ComImport]
    public class CiQRClass : ICiQR, CiQR
    {
        [DispId(2)]
        ...
        [DispId(8)]
        public virtual extern FBarcodeDirections Directions { [TypeLibFunc(1088), DispId(8), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(8), TypeLibFunc(1088), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)][param: In] set; }
